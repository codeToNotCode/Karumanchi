/*
 * To count the number of half nodes in a binary tree
 * half nodes are nodes which have exactly 1 child
 */
...
public class HalfNodeCount
{
	...
	{
		HalfNodeCount hnc = new HalfNodeCount();
		Node root = hnc.createTree();
		System.out.println("Number of h Nodes : " + hnc.halfNodes(root));
	}
